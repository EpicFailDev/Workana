...
const isDraftStatus = (status: string) => ["generated", "draft", "ready", "queued"].includes(status);
        ...
        try {
            ...
            if (result.success) {
                ...
                if (selectedBatch?.id === batchId) {
                    setSelectedBatch((prev: ProposalBatch | null) => prev ? { ...prev, status: result.status } : null);
                }
                fetchBatches();
            }
        } catch (error: any) {
                ...
                <div>
                    ...
                    {proposalsLoading ? (
                        ...
                        <div className={styles.emptyState}>
                            ...
                            <p>
                                Gere ou salve uma proposta a partir dos projetos, ou aguarde o processamento de um lote.
                                As propostas ficam guardadas aqui como rascunhos ou enviadas.
                            </p>
                        </div>
                    ) : (
                                    ...
                                    <div key={proposal.id} className={styles.proposalCard}>
                                        <div className={styles.proposalHeader}>
                                            <a
                                                ...
                                                href={proposal.project_url || `https://www.workana.com/job/${proposal.project_id}`}
                                                target="_blank"
                                        ...
                                        <div className={styles.proposalMetaGrid}>
                                            ...
                                            <div className={styles.proposalMetaItem}>
                                                ...
                                                <span className={styles.metaValue}>{proposal.deadline_days || "—"} dias</span>
                                            </div>
                                            <div className={styles.proposalMetaItem}>
                                            ...
                                            <div className={styles.proposalMetaItem}>
                                                ...
                                                <span className={styles.metaValue}>{formatDate(proposal.sent_at || "")}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className={styles.proposalCardActions}>
                                            ...
                                            {isDraftStatus(proposal.status) && proposal.message && (
                                                <button className={`${styles.btnAction} ${styles.btnActionPrimary}`} onClick={() => handleQuickSend(proposal)}>
                                                    🚀 Enviar
                                                </button>
                                            )}
                                        </div>
