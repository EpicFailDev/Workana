...
import { PUBLICATION_OPTIONS, LANGUAGE_OPTIONS, SCRAPING_PAGES_OPTIONS } from "../../constants/options";
                ...
                >
                    ...
                    <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: "8px" }}>
                        ...
                        <select
                            ...
                            onChange={(e) => onFiltersChange({ ...filters, pages_to_fetch: Number(e.target.value) })}
