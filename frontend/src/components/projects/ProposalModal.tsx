...
export const ProposalModal: React.FC<ProposalModalProps> = ({
    ...
    const hasProposalLoaded = Boolean(proposalData?.proposal && proposalData.proposal.trim().length > 0);
    ...
    return (
        <div className="modal-overlay" onClick={onClose}>
            ...
            >
                {/* Header do Modal */}
                <div className="modal-header" style={{ padding: "1.1rem 1.5rem", borderBottom: "1px solid rgba(255, 255, 255, 0.08)" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", flexWrap: "wrap" }}>
                        <h3 className="modal-title" style={{ margin: 0, fontSize: "1.25rem", fontWeight: 700, display: "flex", alignItems: "center", gap: "8px" }}>
                ...
                <div className="modal-body" style={{ padding: "1.25rem 1.5rem", overflowY: "auto", flex: 1 }}>
                    ...
                    {versions.length > 0 && (
                        <div style={{ marginBottom: "1.25rem" }}>
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.5rem" }}>
                                <span style={{ fontSize: "0.75rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "1px", color: "var(--color-primary-light)" }}>
                            ...
                            >
                                    ...
                                    return (
                                        <div
                                            ...
                                            style={{
                                                display: "flex",
                                                alignItems: "center",
                                                backgroundColor: isSelected ? "rgba(99, 102, 241, 0.2)" : "rgba(15, 23, 42, 0.7)",
                                        ...
                                        >
                                            ...
                                            <span style={{ fontSize: "0.8rem", fontWeight: isSelected ? 700 : 500, color: isSelected ? "#fff" : "#cbd5e1" }}>
                                ...
                                <button
                                    ...
                                    style={{
                                        ...
                                        backgroundColor: showConfigDrawer ? "rgba(99, 102, 241, 0.2)" : "rgba(99, 102, 241, 0.08)",
                    ...
                    {(!hasProposalLoaded || showConfigDrawer) && (
                        ...
                        >
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem" }}>
                                <h4 style={{ margin: 0, fontSize: "0.95rem", fontWeight: 700, color: "var(--color-primary-light)", display: "flex", alignItems: "center", gap: "6px" }}>
                                    <span>🎯</span> Parâmetros da IA para {hasProposalLoaded ? "Nova Versão" : "Gerar Proposta"}
                                </h4>
                                {hasProposalLoaded && (
                                    <button
                                        type="button"
                                        ...
                                        {PRICE_LEVELS.map((level) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <span style={{ fontWeight: 700, fontSize: "0.78rem", color: isSelected ? "#fff" : "#cbd5e1" }}>
                                                        {level.label}
                                                    </span>
                                                </button>
                                            );
                    ...
                    {isGenerating ? (
                        <div style={{ padding: "50px 0", textAlign: "center" }}>
                            <Loader type="scanning" message="Arquitetando proposta de elite, escopo modular e fatiamento do investimento..." />
                        </div>
                    ) : error ? (
                        ...
                        <div>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: "1rem", marginBottom: "1.25rem" }}>
                                ...
                                <div className="card p-3" style={{ border: "1px solid var(--color-border)" }}>
                                    <div className="text-xs text-muted mb-1" style={{ fontWeight: 600, textTransform: "uppercase" }}>
                                        Justificativa Técnica
                                    </div>
                                    <div className="text-xs" style={{ lineHeight: 1.5, opacity: 0.9 }}>
                                        {proposalData?.justification || "Proposta estruturada com Padrão Master MVP, escopo modular fatiado e garantia de entrega validável."}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", marginBottom: "1.25rem" }}>
                                <div className="form-group" style={{ margin: 0 }}>
                                    <label className="form-label" style={{ fontWeight: 600, marginBottom: "0.35rem", fontSize: "0.85rem" }}>
                                        Valor da Proposta (R$)
                                    </label>
                                    <input
                                        type="number"
                            ...
                            <div className="form-group" style={{ margin: 0 }}>
                                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.4rem" }}>
                                    <label className="form-label" style={{ fontWeight: 600, margin: 0, fontSize: "0.9rem" }}>
                                ...
                                <textarea
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (investmentIdx > -1) {
                                            ...
                                            onProposalChange && onProposalChange(proposalPart);
                                            onInvestmentChange && onInvestmentChange(investmentPart);
                                        } else {
                                            onProposalChange && onProposalChange(newFullText);
                                        }
                                    }}
                        ...
                        <div style={{ padding: "30px 0", textAlign: "center", color: "var(--color-text-muted)" }}>
                            ...
                            <h4 style={{ color: "#fff", marginBottom: "0.5rem" }}>Nenhuma proposta gerada ainda</h4>
                            <p style={{ maxWidth: "420px", margin: "0 auto 1.5rem", fontSize: "0.85rem" }}>
                                Escolha o modelo e a modalidade de valor acima e clique no botão para gerar uma proposta técnica altamente persuasiva.
                            </p>
                        </div>
                    )}
                </div>
