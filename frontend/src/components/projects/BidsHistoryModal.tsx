...
export const BidsHistoryModal: React.FC<BidsHistoryModalProps> = ({ data, isLoading, onClose }) => {
        ...
        <div className={styles.dossierHeader}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              ...
              <h3
                style={{ fontSize: '1.2rem', marginTop: '4px', color: 'var(--color-text-bright)' }}
              >
              ...
              >
                <span>
                  ...
                  <strong style={{ color: 'var(--color-primary)' }}>
                    {data?.current_count ?? points[0]?.proposals_count ?? 0} propostas
                  </strong>
                </span>
                <span>
                  Total de snapshots: <strong>{points.length}</strong>
                </span>
              </div>
              ...
              >
                {points.map((p, idx) => {
                  ...
                  const dateStr = p.captured_at
                    ? new Date(p.captured_at).toLocaleString('pt-BR')
                    : 'Recent';
                  return (
                    <div
                      key={idx}
