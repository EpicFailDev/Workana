            ...
            >
                <div className="modal-header" style={{ padding: "1.25rem 1.5rem" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", flexWrap: "wrap" }}>
                        <h3 className="modal-title" style={{ margin: 0, fontSize: "1.15rem", fontWeight: 700, maxWidth: "520px" }}>
                            {item.project_title}
                        </h3>
                ...
                <div className="modal-body" style={{ padding: "1.25rem 1.5rem" }}>
                    <div className={styles.editorMeta}>
                        <span>📋 Projeto: <strong>{item.project_id}</strong></span>
                        {item.project_url && (
                            <a href={item.project_url} target="_blank" rel="noopener noreferrer" className={styles.editorLink}>
                                Ver no Workana ↗
                            </a>
                        )}
                        {item.template_slug && (
                    ...
                    <div className={styles.editorActions}>
                        <button
                            ...
                            style={{ backgroundColor: copied ? "rgba(16, 185, 129, 0.2)" : "var(--color-bg-tertiary)", borderColor: copied ? "#10b981" : "var(--color-border)", color: copied ? "#10b981" : "var(--color-text)" }}
                            onClick={handleCopy}
                        >
                        ...
                        {isDraft && (
                            <button
                                ...
                                style={{ flex: 1.2, backgroundColor: "rgba(59, 130, 246, 0.15)", border: "1px solid rgba(59, 130, 246, 0.4)", color: "#60a5fa", fontWeight: 600 }}
                            >
                        ...
                        {isDraft && (
                            <button
                                ...
                                style={{ flex: 1.6, backgroundColor: "rgba(16, 185, 129, 0.15)", border: "1px solid rgba(16, 185, 129, 0.4)", color: "#10b981", fontWeight: 700 }}
                            >
