        ...
        <div className={styles.container}>
                ...
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="page-title">
                            <span className="text-gradient">Templates de Proposta</span>
                        </h1>
                        <p className="page-subtitle">
                            Crie e gerencie templates para enviar propostas mais rapidamente
                        </p>
                    </div>
                    <button
            ...
            <div className={`card ${styles.variablesCard}`}>
                ...
                <p className={styles.variablesDescription}>
                    Use estas variáveis nos seus templates. Elas serão substituídas automaticamente ao enviar a proposta.
                </p>
            ...
            {showNewForm && (
                <div className={`card ${styles.newTemplateCard}`}>
                    <div className="card-header">
                        <h3 className="card-title">Novo Template</h3>
                        <button
