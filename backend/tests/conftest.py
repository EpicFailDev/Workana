...
if "TEST_DATABASE_URL" in os.environ:
    ...
    os.environ["DATABASE_URL"] = (
        "postgresql+asyncpg://dummy_user:dummy_pass@localhost:5432/dummy_db"
    )
...
def check_db_test_safety(request):
    ...
    if any(
        ...
        for h in [
            ...
            "supabase.com",
            "pooler.supabase.com",
            "cztwxtsuewwacjcgajjz",
            "pgdtcjcxrffwkvbvkjov",
        ]
    ):
        pytest.skip(
            "Bloqueio de segurança: Não é permitido rodar testes contra o banco hospedado em produção."
        )
